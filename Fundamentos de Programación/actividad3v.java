...
public class actividad3 {
    ...
    static int cantidadPacientesContestaronEncuesta() {
        int[][] arregloTotal = {respuestaEncuestaVentanilla01, respuestaEncuestaVentanilla02, respuestaEncuestaVentanilla03, respuestaEncuestaVentanilla04, respuestaEncuestaVentanilla05};
        int sumaTotal = 0;
